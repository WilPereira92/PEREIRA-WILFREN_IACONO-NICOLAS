...
public class DomicilioResquestUpdateDto {
    ...
    public DomicilioResquestUpdateDto() {
    }

    public DomicilioResquestUpdateDto(Long id, String calle, int numero, String localidad, String provincia) {
        this.id = id;
        this.calle = calle;
        this.numero = numero;
